...
/* LE States. See Core_v5.4, Vol 4, Part E, Section 7.6.27 */
#define BT_LE_STATES_PER_CONN_ADV(states)     (states & BIT64_MASK(35))

#if defined(CONFIG_BT_SCAN_AND_INITIATE_IN_PARALLEL_ALLOWED)
/* Passive/Active scanner can be run in parallel with initiator. */
#define BT_LE_STATES_SCAN_INIT(states) (states & (BIT64_MASK(22) | BIT64_MASK(23)))
#else
